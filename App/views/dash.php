                ...
                <ul class="ttr-header-navigation">
                    <li>
                        ...
                        <div class="ttr-header-submenu">
                            <ul>
                                <li><a href="../AuthMVC/App/views/logout.php">Logout</a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <span class="new-users-text">
                                            <a href="#" class="new-users-name"></a>
                                            <span class="new-users-info">categorie: </span>
                                            <br>
                                            <a href="#" class="new-users-info">status: </a>
                                        </span>
                                        <span class="new-users-btn">
                                            <a href="mod_course.php?course_id=>" class="btn button-sm green">Modify</a>
                                        </span>
